...
namespace Lims.Tools
{
    public partial class fmMain : Form
    {
        ...
        {
            string [] ntKeys= ConfigurationManager.AppSettings.Get("ntHotKey").Split(new char[]{'+'});
            string[] csKeys = ConfigurationManager.AppSettings.Get("csHotKey").Split(new char[] {'+'});
            string[] ssKeys = ConfigurationManager.AppSettings.Get("ssHotKey").Split(new char[] {'+'});
            

            //Keys key=new Keys();
            string keyName = string.Empty;
            //string keyName = Enum.GetName(typeof(Keys), Keys.Control).ToString();//Control            
            //keyName=Enum.Format(typeof(Keys), Keys.Control, "a{0}a");
            //keyName = Enum.Parse(typeof(Keys), "A").ToString();
            //keyName = Enum.Parse(typeof (HotKey.KeyModifiers), "2").ToString();
            ...
            //    Enum.Parse(typeof(Keys), ntKeys[2])
            //    );
